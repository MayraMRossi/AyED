...
int main()
{
    ...
    inicializarVector(repTotal, 14);
    cargarRep(zonas, 14, 4);
    cout<<endl;
    mostrarCantXZona (zonas,14,4, repTotal);
    cout<<endl;
    transpVacio (zonas,14,4);
    cout<<endl;
    repXZona (repTotal, 14);
...
void mostrarCantXZona (int zonas [][4] ,unsigned f, unsigned c, int repTotal[])
{
    ...
    for(int i=0; i<f ;i++)
    {
        ...
        for(int j=0; j<c ;j++)
        {
            switch(j)
            {
                case 0: cout<<"Auto: "<<zonas[i][j]<<"  "; break;
                case 1: cout<<"Moto: "<<zonas[i][j]<<"  "; break;
                case 2: cout<<"Camioneta: "<<zonas[i][j]<<"  "; break;
                case 3: cout<<"Camion: "<<zonas[i][j]<<"  "; break;
            }
...
void transpVacio (int zonas [][4] ,unsigned f, unsigned c)
{
    ...
    for(int j=0; j<c ;j++)
    {
        ...
        if(suma==0)
        {
            switch(j)
            {
                case 0: cout<<"Auto"<<endl; break;
                case 1: cout<<"Moto"<<endl; break;
                case 2: cout<<"Camioneta"<<endl; break;
                case 3: cout<<"Camion"<<endl; break;
            }
        }
